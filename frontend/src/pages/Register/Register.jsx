...
const Register = () => {
  ...
  const handleSpeakerRegisterSubmit = async (e) => {
    ...
    try {
      ...
      const result = await api.post("/api/signup", {
        ...
        country: speaker.institutionCountry,
        participantType: "SPEAKER",
      });
      localStorage.setItem("speakerToken", result.token || "");
      localStorage.setItem("speakerData", JSON.stringify({ ...speaker, fullName }));
      setSubmitted(true);
    } catch (error) {
      alert(error.message);
    }
  ...
  const handleSpeakerLoginSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("speakerToken", result.token || "");
      localStorage.setItem("speakerData", JSON.stringify({
